...
async function fetchBreweries(zipCode) {
    ...
    try {
        ...
        return apiData.map(function (brewery) {
            return {
...
function addToVisited(breweryId, breweries) {
...
function createBreweryCard(brewery, breweries) {
